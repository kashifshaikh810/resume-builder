...
const InternshipInputBox = (props) => {
  const descIcons = [
          ...
          {props.internshipInputList.map((x, i) => {
            ...
            return (
              <div
                ...
                onMouseEnter={() => {
                  props.setIsShowInternshipBoxIcon({
                    show: true,
                    num: i,
                  });
                }}
              ...
              >
                <div
                  ...
                  className={`border border-gray-200 w-11/12 ${
                    props?.isShowInternshipBoxInput.show ? `h-auto` : `h-20`
                  } mt-7 hover:cursor-pointer`}
                  onClick={() =>
                    props?.isShowInternshipBoxInput.show === false &&
                    props.setIsShowInternshipBoxInput({
                      ...props.isShowInternshipBoxInput,
                      show: !props?.isShowInternshipBoxInput.show,
                      num: i,
                    })
                  }
                >
                  <div className="flex flex-row items-center">
                    <div className="ml-5 w-10/12">
                      <div className="flex flex-row items-center">
                        <p
                          className={`${
                            props.isShowInternshipBoxIcon.show &&
                            props.isShowInternshipBoxIcon.num === i
                              ? `text-blue-400`
                              : `text-black`
                    ...
                    >
                      {props?.isShowInternshipBoxInput.show &&
                      props?.isShowInternshipBoxInput.num === i ? (
                        <BiChevronUp
                        ...
                        <div className="flex flex-row items-end">
                          <div>
                            ...
                            <input
                              ...
                              value={x.jobTitle}
                              onChange={(e) =>
                                props.internshipHandleInputChange(e, i)
                              }
                        ...
                        <div className="w-11/12 p-4 bg-gray-100 max-[767px]:w-full">
                            ...
                            {descIcons.map((item, index) => (
                              <div
                                ...
                                className={`m-2 mt-0 ml-0 hover:cursor-pointer hover:text-blue-400  ${
                                  (props?.isChangedInternshipDescInputText
                                    ?.num === index &&
                                    props?.isChangedInternshipDescInputText
                                      ?.name === "bold") ||
                                  (props?.isChangedInternshipDescInputText
                                ...
                                onClick={() =>
                                  props.setIsChangedInternshipDescInputText({
                                    name: item.name,
                                    num: index,
                                  })
                                }
                          ...
                          <textarea
                            ...
                            className={`w-full h-48 bg-gray-100 border-none text-gray-800 overflow-hidden outline-none ${
                              (props?.isChangedInternshipDescInputText?.name ===
                                "normal" &&
                                `font-normal`) ||
                              (props?.isChangedInternshipDescInputText?.name ===
                                "bold" &&
                  ...
                  props.isShowInternshipBoxIcon.num === i && (
                    <div className="relative top-16 left-2 bottom-0 right-0">
                      <RiDeleteBin5Line
                        ...
                        onClick={() => props.internshipHandleRemoveClick(i)}
                      />
                    </div>
                  )}
              </div>
  ...
  return <div>{internshipSection()}</div>;
};

export default InternshipInputBox;

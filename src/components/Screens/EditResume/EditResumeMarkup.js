                  ...
                  <div className="flex flex-row items-end">
                    <div className="mt-4">
                     ...
                     text-gray-800 border-none overflow-hidden
                      outline-none max-[767px]:w-full"
                        value={
                          tabName === "resumes" ? wantedJobTitle : fullName
                        }
                        onChange={(e) =>
                          tabName === "resumes"
                    ...
                    <div className="mt-6 pt-6">
                      ...
                      <div className="mt-6 pt-6">
                        <div
                          ...
                          onMouseLeave={() =>
                            props.setIsShowEducationIcon(false)
                          }
                        >
                            ...
                            `}
                              ...
                              >
                                <p
                                  className={`${
                                    props?.experienceLevelIsHovered.shown &&
                                    props?.experienceLevelIsHovered.num ===
                                      index
                                      ? `text-blue-400`
                                      : `text-gray-600`
                                  }`}
                      ...
                      <div className="mt-5 pt-5">
                        <div
                          ...
                          onMouseLeave={() =>
                            props.setIsShowLanguagesIcon(false)
                          }
                        >

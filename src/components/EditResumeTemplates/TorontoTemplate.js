        ...
        {props.profileImage && (
          <>
            <img
              ...
              alt="prof"
              className="w-[3rem] h-[3.5rem]"
            />
            <div className="relative -top-2">
              <p className="text-2xl font-bold ml-8 pl-8">
                {resumeData?.firstName}
              </p>
              <p className="text-2xl font-bold ml-8 pl-8 relative -top-2">
                {resumeData?.lastName}
              </p>
            </div>
          </>
      ...
      >
        ...
        <div className={!props.profileImage && `w-7/12`}>
          ...
          {resumeData?.professionalSummary && (
            <div className="ml-1 w-11/12 h-full">
      ...
      <div className="grid grid-cols-[200px_minmax(200px,_1fr)_100px]">
        <div>
          {resumeData?.employmentInputList?.length >= 1 ? (
            <div>
              <p className="text-[14px] font-bold">{props?.employmentInput}</p>
          ...
          {resumeData?.educationInputList?.length >= 1 ? (
            ...
            >
              <p className="text-[14px] font-bold">{props?.educationInput}</p>
        ...
        <div className="flex flex-col flex-1 items-end mr-10">
          {resumeData?.websiteInputList?.length >= 1 ? (
            <div className="bg-[#eeeeee] w-11/12 h-auto pl-2 pt-1 pb-1 rounded-lg">
              <p className="text-[14px] font-bold">
          ...
          {resumeData?.skillsInputList?.length >= 1 ? (
            <div className="bg-[#eeeeee] w-11/12 h-auto pl-2 pt-1 pb-1 mt-1 rounded-lg">
          ...
          {resumeData?.hobbies && (
            <div className="bg-[#eeeeee] w-11/12 h-auto pl-2 pt-1 pb-1 mt-1 rounded-lg">
              <p className="text-[14px] font-semibold">{props?.hobbiesInput}</p>
                ...
                resumeData?.languagesInputList.map((item, index) => {
                  if (item?.level === "Select Level") {
                    ...
                    return (
                      <div key={index} className="flex flex-row">
                        {item?.language ? (
                          <p className="text-[6px] mt-0.5">{item?.language}</p>
                        ) : (
                          ""
                        )}
                        {item?.language ? (
          ...
          {resumeData?.referencesInputList?.length >= 1 ? (
            <div className="bg-[#eeeeee] w-11/12 h-auto pl-2 pt-1 pb-1 mt-1 rounded-lg">
              <p className="text-[14px] font-bold">{props?.referencesInput}</p>
